<?php /* Smarty version Smarty-3.1.7, created on 2020-09-12 07:08:47
         compiled from "/var/www/html/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2556406285f5c541045e694-04875184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2556406285f5c541045e694-04875184',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5f5c5410504bf',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5f5c5410504bf')) {function content_5f5c5410504bf($_smarty_tpl) {?>

<?php $_smarty_tpl->tpl_vars['basic'] = new Smarty_variable(array('firstname','lastname','phone','account_id','title','department','birthday','assigned_user_id','createdtime','notify_owner','modifiedtime'), null, 0);?><?php $_smarty_tpl->tpl_vars['contact'] = new Smarty_variable(array('contact_no','mobile','homephone','otherphone','fax','secondaryemail','emailoptout','email','assistantphone','assistant'), null, 0);?><?php $_smarty_tpl->tpl_vars['moreInfo'] = new Smarty_variable(array('reference','contact_id','description','portal','support_start_date','support_end_date','isconvertedfromlead','source','donotcall','leadsource'), null, 0);?><?php $_smarty_tpl->tpl_vars['address'] = new Smarty_variable(array('mailingstreet','otherstreet','mailingpobox','otherpobox','mailingcity','othercity','mailingstate','otherstate','mailingzip','otherzip','mailingcountry','othercountry'), null, 0);?><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
$_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_NAME']->value = $_smarty_tpl->tpl_vars['FIELD_MODEL']->key;
?>
                                        <?php if (in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['basic']->value)){?>
                                        <div class="col-md-6">
                                        <div class="detail-info">
                                            <label class="detail-header"><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
</label>
                                            <label class="detail-value">
                                            <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')=="None"||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')==null){?>
                                                None
                                            <?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')==0||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')=="0"){?>
                                                No
                                            <?php }elseif($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')==1||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')=="1"){?>
                                                Yes
                                            <?php }else{ ?>
...
$_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_NAME']->value = $_smarty_tpl->tpl_vars['FIELD_MODEL']->key;
?>
                                        <?php if (in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['moreInfo']->value)){?>
                                        <div class="col-md-6">
                                        <div class="detail-info">
                                            <label class="detail-header"><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
</label>
...
$_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_NAME']->value = $_smarty_tpl->tpl_vars['FIELD_MODEL']->key;
?>
                                        <?php if (in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['contact']->value)){?>
                                        <div class="col-md-6">
                                        <div class="detail-info">
                                            <label class="detail-header"><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
</label>
...
$_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = true;
 $_smarty_tpl->tpl_vars['FIELD_NAME']->value = $_smarty_tpl->tpl_vars['FIELD_MODEL']->key;
?>
                                        <?php if (in_array($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['address']->value)){?>
                                        <div class="col-md-6">
                                        <div class="detail-info">
                                            <label class="detail-header"><?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label');?>
</label>
