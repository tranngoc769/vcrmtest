<?php /* Smarty version Smarty-3.1.7, created on 2020-09-12 09:53:52
         compiled from "/home/tranngoc/Desktop/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/partials/Topbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12974918895f5c9ab0c25c54-39899325%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c57cdff4bb62199c35646c7ccef2f00d6bfbb7ea' => 
    array (
      0 => '/home/tranngoc/Desktop/vtigercrm/includes/runtime/../../layouts/v7/modules/Vtiger/partials/Topbar.tpl',
      1 => 1599898250,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12974918895f5c9ab0c25c54-39899325',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f5c9ab1212c4',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f5c9ab1212c4')) {function content_5f5c9ab1212c4($_smarty_tpl) {?>
...
<?php $_smarty_tpl->tpl_vars['APP_IMAGE_MAP'] = new Smarty_variable(Vtiger_MenuStructure_Model::getAppIcons(), null, 0);?><script type="text/javascript">var infocall = {username: "<?php echo $_smarty_tpl->tpl_vars['PHONE_CRM']->value;?>
",password: "<?php echo $_smarty_tpl->tpl_vars['PASS_CRM']->value;?>
",uid: "<?php echo $_smarty_tpl->tpl_vars['PHONE_CRM']->value;?>
",domain : "<?php echo $_smarty_tpl->tpl_vars['PBX_DOMAIN']->value;?>
",proxy : "<?php echo $_smarty_tpl->tpl_vars['PBX_PROXY']->value;?>
",port : "<?php echo $_smarty_tpl->tpl_vars['PBX_PORT']->value;?>
"};function getInfocall(){return this.infocall;}</script><nav class="navbar navbar-inverse navbar-fixed-top app-fixed-navbar"><div class="container-fluid global-nav"><div class="row"><div class="col-lg-3 col-md-3 col-sm-4 col-xs-8 app-navigator-container"><div class="row"><div id="appnavigator" class="col-sm-2 col-xs-2 cursorPointer app-switcher-container" data-app-class="<?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Home'||!$_smarty_tpl->tpl_vars['MODULE']->value){?>fa-dashboard<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['APP_IMAGE_MAP']->value[$_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value];?>
