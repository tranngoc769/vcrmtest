...
<script src="{vresource_url('layouts/v7/lib/jssip/views.js')}"></script>
<script src="{vresource_url('layouts/v7/lib/jssip/jsconfig.js')}"></script>
<script src="{vresource_url('layouts/v7/lib/jssip/modal.js')}"></script>
{* Dial Pad *}
<script src="{vresource_url('layouts/v7/skins/dialpad/js/dial.js')}"></script>
