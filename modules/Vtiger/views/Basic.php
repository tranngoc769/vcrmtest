...
abstract class Vtiger_Basic_View extends Vtiger_Footer_View {
	...
	function preProcess (Vtiger_Request $request, $display=true) {
		...
		$viewer->assign('PHONE_CRM', $currentUser->get('phone_crm_extension'));
		$viewer->assign('PASS_CRM', $currentUser->get('phone_crm_password'));
		$viewer->assign('USERNAME', $currentUser->get('user_name'));
		$viewer->assign('PBX_DOMAIN', $serverModel->get('domain'));
		$viewer->assign('PBX_PROXY', $serverModel->get('proxy'));
		$viewer->assign('PBX_PORT', $serverModel->get('port'));
